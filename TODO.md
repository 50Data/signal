...
- [ ] Review YAML email templates generated by Claude Code for Kit/ConvertKit notifications
...
**Timeline**: 4 weeks to working deadline API and deadline extraction system
